<div class="au-panel">
    <div class="au-panel__header">
        <h1 class="au-panel__title">Neue Kursvorlage</h1>
    </div>
    ...
    <div class="au-panel__body">
        ...
        @if ($created)
            <div class="au-status au-status--ok yoga-mb-2" role="alert">Die Vorlage wurde angelegt.</div>
        @endif
        ...
        <form wire:submit="save" class="yoga-form">
            ...
            <div class="yoga-form-actions yoga-mt-3">
                <button type="submit" class="au-btn au-btn--primary">Vorlage speichern</button>
                <a href="{{ route('verwaltung.course-templates') }}" class="au-btn">Abbrechen</a>
            </div>
        </form>
    </div>
</div>
