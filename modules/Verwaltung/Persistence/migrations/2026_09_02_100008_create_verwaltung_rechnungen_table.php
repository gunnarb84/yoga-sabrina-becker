...
return new class () extends Migration {
    ...
    {
        Schema::create('verwaltung_rechnungen', function (Blueprint $table): void {
            ...
            $table->index('zahlung_id', 'idx_rechnungen_zahlung');

            $table->foreign('zahlung_id', 'fk_rechnungen_zahlung')
                ->references('id')
    ...
    {
        Schema::dropIfExists('verwaltung_rechnungen');
    }
};
