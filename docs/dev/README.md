...
Diese Dokumentation richtet sich an Entwickler/innen, die das System weiterbauen, betreiben oder debuggen.

## Erste Schritte

- [Setup](setup.md)
- [Architekturübersicht](architektur.md)
- [Projektstruktur](referenz/projektstruktur.md)
...
- [Schnittstellen](referenz/schnittstellen.md)
...
- [Endkunden-Dokumentation](../user/README.md)
- [PROJEKT.md](../../../PROJEKT.md)
- [harness-php/_architecture.md](../../../harness-php/_architecture.md)
- [harness-php/_design.md](../../../harness-php/_design.md)
- [projekt/_domaene.md](../../../projekt/_domaene.md)
