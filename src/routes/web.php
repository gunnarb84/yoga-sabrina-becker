...
use Yoga\Modules\Verwaltung\Ui\Payment\BulkCashPayments;
...
Route::middleware('auth')->group(function (): void {
    ...
    Route::get('/verwaltung/kursvorlagen', CourseTemplateList::class)->name('verwaltung.course-templates');
    Route::get('/verwaltung/kursvorlagen/neu', CreateCourseTemplate::class)->name('verwaltung.course-template.create');
    Route::get('/verwaltung/kursvorlagen/{id}/bearbeiten', EditCourseTemplate::class)->name('verwaltung.course-template.edit');
